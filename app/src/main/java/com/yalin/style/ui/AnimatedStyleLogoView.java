...
import com.yalin.style.util.LogoPaths;
import com.yalin.style.util.MathUtil;
import com.yalin.style.util.SvgPathParser;
import java.text.ParseException;

public class AnimatedStyleLogoView extends View {

  private static final String TAG = "AnimatedStyleLogoView";
  ...
  public AnimatedStyleLogoView(Context context) {
    super(context);
    init();
  }

  public AnimatedStyleLogoView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public AnimatedStyleLogoView(Context context, AttributeSet attrs, int defStyle) {
