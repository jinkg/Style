...
public class StyleProvider extends ContentProvider {
  ...
  public Uri insert(@NonNull Uri uri, ContentValues values) {
    ...
    switch (uriEnum) {
      case WALLPAPER:
        return StyleContract.Wallpaper.buildWallpaperUri(values.getAsString(StyleContract.Wallpaper.COLUMN_NAME_WALLPAPER_ID));
      default: {
...
//    notifyChange(uri);
  ...
  private Uri queryUriForShow() {
    Cursor cursor = query(StyleContract.Wallpaper.CONTENT_LAST_WALLPAPER_URI,
